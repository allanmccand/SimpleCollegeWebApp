          ...
          {props.professors.map((professor) => (
            ...
            >
              ...
              <td>
                ...
                >
                  {new Intl.DateTimeFormat('en-US', {month: '2-digit',day: '2-digit',year: 'numeric'}).format(new Date(professor.dob+"T00:00:00.000"))}
                </h2>
              </td>
              <td>
                <h2
              ...
              <td>
                <button onClick={() => deleteProfessor(professor.professorId)} >
                  Delete Professor
                </button>
              </td>
            </tr>
